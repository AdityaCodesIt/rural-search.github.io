      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              <span className="text-2xl font-bold text-terracotta">RuralReach</span>
              <span className="text-sm text-leaf-green ml-2">Maharashtra</span>
            </div>
            <p className="text-gray-300 mb-4">
              Connecting rural artisans with global markets. Empowering traditional crafts and sustainable livelihoods.
            </p>
        ...
        <div className="border-t border-gray-600 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">
            © 2024 RuralReach Maharashtra. All rights reserved.
          </p>
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <Link to="/admin-login" className="text-xs text-gray-400 hover:text-gray-300">
              Admin Access
            </Link>
