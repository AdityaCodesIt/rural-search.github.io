...
-- MySQL/MariaDB Compatible - FIXED VERSION
...
DROP DATABASE IF EXISTS `ruralreach`;
CREATE DATABASE `ruralreach` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `ruralreach`;
...
INSERT INTO `products` (`seller_id`, `title`, `slug`, `description`, `category`, `current_price`, `original_price`, `stock`, `location`, `verified`, `featured`, `status`, `material`, `age_group`, `sku`, `created_at`) VALUES
(2, 'Handcrafted Sawantwadi Wooden Toys', 'handcrafted-sawantwadi-wooden-toys-001', 'Authentic hand-painted wooden toys crafted by artisans from Sawantwadi, Maharashtra — known for vibrant colors, durability, and cultural heritage.', 'handicrafts', 750.00, 999.00, 25, 'Sawantwadi, Sindhudurg District, Maharashtra', 1, 1, 'active', 'Sustainable Wood', '3-5', 'SAW001', NOW());
